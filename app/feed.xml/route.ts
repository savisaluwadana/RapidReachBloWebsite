...
export async function GET() {
  ...
  const xml = `<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>RapidReach — Developer Intelligence</title><link>${esc(siteUrl)}</link><description>Fast signal, practical analysis, and developer-tool intelligence for people who build software.</description><language>en</language>${items}</channel></rss>`;

...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="brand-proof-strip" aria-label="RapidReach editorial formats"><div className="shell brand-proof-row"><span>Follow the signal</span><Link href="#signal-desk">Signal Desk <span>Live</span></Link><Link href="/briefing">RapidReach Brief <span>Briefing</span></Link><Link href="/launches">Launch Radar <span>New</span></Link><Link href="/collections">Builder Stacks <span>Curated</span></Link></div></section>
      ...
      <section className="brand-formats shell" aria-labelledby="formats-title">
        ...
        <div className="brand-format-grid">
          <article className="brand-format-card"><span>01 / Daily signal</span><h3>Signal Desk</h3><p>The dense view of what is moving across developer technology, with the important story surfaced first.</p><Link href="#signal-desk">Open the desk →</Link></article>

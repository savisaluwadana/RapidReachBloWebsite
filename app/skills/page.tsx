...
import { getSkillView } from '@/lib/rapidreach/read-model'

export default async function SkillsPage() {
  const skills = await getSkillView()
  return (
    <main className="min-h-screen bg-deep-charcoal text-white">
      ...
      <section className="py-16"><div className="container mx-auto px-6"><div className="mx-auto max-w-6xl"><SkillsGraph skills={skills} /></div></div></section>
      <Footer />
    </main>
  )
}

...
import { validDate } from "@/lib/public-format";
...
export default async function LaunchBoardPage() {
  ...
  const board = selected.length ? selected : [...tools].sort((a,b) => launchTimestamp(b.launchedAt) - launchTimestamp(a.launchedAt)).slice(0, 8);

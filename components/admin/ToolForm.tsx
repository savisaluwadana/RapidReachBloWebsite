...
import { saveTool } from "@/app/admin/tool-actions";
...
export function ToolForm({ tool, categories }: { tool?: Tool | null; categories: Category[] }) {
  return (
    <form action={saveTool} className="cms-editor">
      ...
      <MediaUploader inputName="logoUrl" label="Tool logo" kind="tool-logo" initialUrls={tool?.logoUrl ? [tool.logoUrl] : []} help="Upload a square PNG/WebP logo, or paste an existing HTTPS logo URL." />

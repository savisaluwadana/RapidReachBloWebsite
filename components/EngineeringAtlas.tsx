...
const nodes = [
  { id: 'runtime', label: 'Runtime', description: 'Containers, Kubernetes, scheduling and workload behaviour.', href: '/category/kubernetes', icon: Boxes, x: '20%', y: '24%' },
  { id: 'delivery', label: 'Delivery', description: 'CI/CD, GitOps, releases and progressive delivery.', href: '/category/cicd', icon: GitBranch, x: '78%', y: '22%' },
  { id: 'platform', label: 'Platform', description: 'Internal platforms, paved roads and developer experience.', href: '/category/platform-engineering', icon: Layers3, x: '50%', y: '48%' },
  { id: 'cloud', label: 'Cloud', description: 'Infrastructure, architecture, cost and operational trade-offs.', href: '/category/cloud', icon: Cloud, x: '18%', y: '78%' },
  { id: 'reliability', label: 'Reliability', description: 'Observability, incidents, SLOs and production debugging.', href: '/category/observability', icon: Activity, x: '80%', y: '76%' },
  { id: 'security', label: 'Security', description: 'Workload policy, secrets and software supply-chain security.', href: '/category/security', icon: LockKeyhole, x: '50%', y: '88%' },
]
